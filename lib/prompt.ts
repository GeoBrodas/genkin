...
export const SYSTEMPROMPT = `\
    ...
    If the user want to create a new transaction entry for inlfow or outflow, call \`createTransactions\` tool. Automatically assign category based on user prompt. Call this tool automatically if user enters a transaction.
`;
